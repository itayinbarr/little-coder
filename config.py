"""Configuration management for little-coder (multi-provider)."""
import os
import json
from pathlib import Path

CONFIG_DIR        = Path.home() / ".little-coder"
...
def load_config() -> dict:
    # Migrate from old .little-coder config dir if it exists
    old_config_dir = Path.home() / ".little-coder"
